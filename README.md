...
First Umbrel app in development: 
- Nerva Node. 
...
To use my Community App Store, you can add the GitHub url https://github.com/GitHub-Vadrigar/umbrel-apps.git to the umbrelOS user interface as shown in the following demo:
